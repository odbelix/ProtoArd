...
template <typename Type>
void LList<Type>::senial()
{
    

  // continue looping until hardware reset.
  while (true) {
    digitalWrite (error_lista, HIGH); // sets the LED on.
    delay (250);                 // pauses 1/4 of second.
    digitalWrite (error_lista, LOW);  // sets the LED off.
    delay (250);                 // pauses 1/4 of second.
  }
}  
